...
print(
    "Difference"
)  # what items in 1st set is diff. to second (perspective of first set)
...
outdoor_gadgets2 = {
    key for key, value in activity_gadgets.items() if value in outdoor_activities
}
# ".items()" = view object (list of key-value pairs (tuples) to unpack)
...
# print("List comprehension way")
indoor_gadgets2 = {
    key for key, value in activity_gadgets.items() if value in indoor_activities
}
